                        ...
                        <div className="card border-0 shadow-sm mb-4">
                            <div className="card-body p-4">
                                <div className="mb-4" style={{
                                    ...
                                    <h4 className="fw-bold mb-0">بناء مؤشر أداء &gt; تعبئة النموذج</h4>
                                </div>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="row g-3">
                                        ...
                                        <div className="col-md-6">
                                            <label className="form-label fw-bold">
                                                تحديد الغرض من بناء المؤشر <span className="text-danger">*</span>
                                            </label>
                                            <input
                                                type="text"
                                                className="form-control"
                                                name="indicatorPurpose"
                                                placeholder="الغرض"
                                                value={formData.indicatorPurpose}
                                                onChange={handleChange}
                                                required
                                            />
                                        </div>
                                        ...
                                        <div className="col-12">
                                            <label className="form-label fw-bold">
                                                وصف المؤشر المراد بناءه <span className="text-danger">*</span>
                                            </label>
                                            <textarea
                                                className="form-control"
                                                name="indicatorDescription"
                                                rows="5"
                                                placeholder="ادخل وصف المؤشر بالتفصيل..."
                                        ...
                                        <div className="col-12">
                                            <div className="alert alert-info" role="alert">
                                                ...
                                                <strong>نصيحة:</strong> يرجى تحديد الأهداف الاستراتيجية والبيانات المطلوبة لبناء المؤشر بشكل دقيق لضمان الحصول على نتائج فعالة.
                                            </div>
                                        </div>
