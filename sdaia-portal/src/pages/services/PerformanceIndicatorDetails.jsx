...
export default function PerformanceIndicatorDetails() {
                ...
                <div className="col-lg-4">
                    <div className="bg-light p-4 rounded shadow-sm">
                        ...
                        <div className="mb-4">
                            ...
                            <p className="text-end text-muted">حتى 5 أيام عمل</p>
                        </div>
                ...
                <div className="col-lg-8">
                    ...
                    <div className="p-4 rounded shadow-sm mb-4" style={{backgroundColor: 'rgba(25, 135, 84, 0.08)'}}>
                        <div className="row">
                            ...
                            <div className="col-lg-8">
                                <h2 className="fw-bold mb-4 text-end">بناء مؤشر أداء</h2>
                                <div className="mb-4">
                                    <span className="badge bg-secondary">موظفي الأمانة</span>
                                </div>
                                <p className="text-end" style={{lineHeight: "1.8"}}>
                                    استخدام الفرص المتاحة لتجميع وتحليل البيانات الإحصائية والحالية المتاحة من قبل الإدارات/ الوكالات للتقييم الذاتي ومقارنات معيارية الأداء وحدات معيار الأداء وتحسين الأداء المؤسسي والبرامج والمشروعات والخدمات التنموية لتحقيق أهداف الكفاءة القرار المناسب والاستراتيجيات والبرامج والمشروعات والخدمات التنموية لتحقيق أهداف الكفاءة.
                                </p>
                            </div>
                            ...
                            <div className="col-lg-4 d-flex flex-column justify-content-start align-items-start gap-3">
                                ...
                                <Link to="/services/performance-indicator" className="btn btn-success w-100 py-2">
                                    تعبئة النموذج
                                </Link>
                            </div>
                        </div>
