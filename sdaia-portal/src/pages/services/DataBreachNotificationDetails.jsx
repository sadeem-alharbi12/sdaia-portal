...
export default function DataBreachNotificationDetails() {
                ...
                <div className="col-lg-4">
                    <div className="bg-light p-4 rounded shadow-sm">
                        ...
                        <div className="mb-4">
                            ...
                            <p className="text-end text-muted"> فوري  </p>
                        </div>
                ...
                <div className="col-lg-8">
                    ...
                    <div className="p-4 rounded shadow-sm mb-4" style={{backgroundColor: 'rgba(25, 135, 84, 0.08)'}}>
                        <div className="row">
                            ...
                            <div className="col-lg-8">
                                <h2 className="fw-bold mb-4 text-end">إشعار تسريب البيانات</h2>
                                <div className="mb-4">
                                    <span className="badge bg-secondary">موظفي الأمانة</span>
                                </div>
                                <p className="text-end" style={{lineHeight: "1.8"}}>
                                    خدمة مكتب إشعار الجهات الحكومية من التبليغ عن حالة تسريب البيانات الحساسية أو البيانات الشخصية أو أي تطبيق حماية البيانات الشخصية. إذ أنه من خلال تلك الخدمة يتم التبليغ عن حالات التسريب بشكل فوري والإجراءات المتخذة من "اللائحة التنفيذية لحماية البيانات الشخصية" أو تطبيق حماية البيانات الشخصية وتحسين المشاركة المجتمعية.
                                </p>
                            </div>
                            ...
                            <div className="col-lg-4 d-flex flex-column justify-content-start align-items-start gap-3">
                                ...
                                <Link to="/services/data-breach-notification" className="btn btn-success w-100 py-2">
                                    تعبئة النموذج
                                </Link>
                            </div>
                        </div>
