...
export default function OpenDataPublishingDetails() {
                ...
                <div className="col-lg-8">
                    ...
                    <div className="p-4 rounded shadow-sm mb-4" style={{backgroundColor: 'rgba(25, 135, 84, 0.08)'}}>
                        <div className="row">
                            ...
                            <div className="col-lg-8">
                                <h2 className="fw-bold mb-4 text-end">نشر البيانات المفتوحة</h2>
                                <div className="mb-4">
                                    <span className="badge bg-secondary">موظفي الأمانة</span>
                                </div>
                                <p className="text-end" style={{lineHeight: "1.8"}}>
                                    عبر منصة البيانات المفتوحة - في منصة موحدة قابلة لإعادة الاستخدام يمكن الحصول عليها أو تحميلها أو بناء مختلف التطبيقات الإلكترونية أو المشاريع البحثية وذلك لتحقيق قيمة إضافة لتلك البيانات من خلال التطبيقات التكنولوجية والمشاريع البحثية وتحسين المشاركة المجتمعية.
                                </p>
                            </div>
                            ...
                            <div className="col-lg-4 d-flex flex-column justify-content-start align-items-start gap-3">
                                ...
                                <Link to="/services/open-data-publishing" className="btn btn-success w-100 py-2">
                                    تعبئة النموذج
                                </Link>
                            </div>
                        </div>
